  ...
  return (
    <ul id="station-items">
      {state.stations.map((station) => (
        <li key={station.id}>
         <p className='flex gap-4 pb-2 text-sm font-semibold'><Image src="/leaflet/images/marker-icon.png" alt='normal-marker' width={16} height={24} className='h-6 w-4' />{station.name}</p>
